...
exports.simulateType = simulateType;
exports.simulateKeyCombo = simulateKeyCombo;
...
function runPowerShell(script) {
    const result = (0, node_child_process_1.spawnSync)('powershell.exe', ['-NoProfile', '-NonInteractive', '-Command', script], { encoding: 'utf8', timeout: ACTION_TIMEOUT_MS });
    if (result.error) {
