# Requirements Archive: v1.3 Window Picker & LLM-Actionable Capture
...
- [x] **INTG-03**: Captured path + metadata injected into active pane's ChatInputBar on window selection
